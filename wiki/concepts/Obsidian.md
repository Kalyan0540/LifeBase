...
- **Download attachments hotkey** — `Settings → Hotkeys → Download attachments for current file`. Saves all images locally to `raw/assets/` so they don't rely on external URLs.
