...
- [[Custom Variable - Number Output]] — Fixed numeric values; behaves as numeric-coded categories in count crosstabs. Metric aggregation (mean / sum / average / score) is expected but is a separate analytical capability.
...
|---|---|---|---|
| Assigns | Fixed text label | Fixed numeric value | Value from another variable |
| Used for | Segmentation, readable groups | Numeric coding, score buckets | Combining split variables |
...
- Decide whether metric aggregation for number outputs is part of MVP or a later analytics enhancement.
- Edge cases when user switches output type between text and numeric after partial setup.

---

*Sources: [[Custom Variable Creation - Text Output]] · [[Custom Variable Creation - Number Output]] · [[Custom Variable Creation - Variable Output]]*
*Updated: 2026-05-20*
