...
- [x] Sprint Grooming Comments.
  - [x] Check what's best design solution for - At-least 1 table option should be selected to view data. - Completed today
...
- [/] Persona Bot's UX/UI design.
  - [x] First Draft + Review. - Last week 2nd and 3rd
  - [ ] Final Draft + Review.
  - [ ] Dev Handoff.
