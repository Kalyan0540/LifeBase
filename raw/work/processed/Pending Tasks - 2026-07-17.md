...
- [x] Design QA: Crosstabs table layouts testing without data (ED-860 Dev Ticket).
...
- [ ] Sync with Subair and the team on Persona Bot data needs and required user/persona details.
- [ ] Document all UX/UI feedback and points discussed in the Bank of America call for widget and desktop views.
