...
- [ ] Work on the crosstabs new comments by Pradnya.
  ...
  - [x] Create sections in Figma for the crosstabs design QA testing file.
  - [ ] Create total column for nesting table.
  - [ ] Remove old Figma designs from the Final UJ's.
  - [x] Ideate on the saving flow for filters (remove the bottom rename and make it same like new variable flow)
...
- [/] Persona Bot's UX/UI design.
  ...
  - [x] Ideation - Create two substantively different first-page/core app mock-up options.
  - [ ] First Draft + Review.
  - [ ] Final Draft + Review.
  - [ ] Dev Handoff.
