# Pending Tasks - 2026-06-25

## Cross Tabs

### P0

- [x] Recheck and resolve the issues of the initial Design QA bugs.
- [ ] Sprint Grooming Comments.
  - [ ] Check what's best design solution for - At-least 1 table option should be selected to view data.
  - [x] Add warning banner all places while editing public filter in the UI.
  - [x] Add a flow for edit - saved private filter (without banner).
...
- [/] Work on the crosstabs new comments by Pradnya.
  ...
  - [x] Create total column for nesting table.
