...
- [/] Design system colour tokens. `P2`
...
- [ ] Summarisation backend flag turn on/off for member side. `P2`
- [ ] Experiment on UX improvements for AI summaries. `P3`
...
- [ ] Claude skills quick demo recording. `P3`
- [/] Persona Bot's UX/UI design. `P0`
  ...
  - [ ] Final Draft + Review.
  - [ ] Dev Handoff.
  - [x] Check with Tish on prioritization so Persona Bots can move in parallel with Enlyta work.
