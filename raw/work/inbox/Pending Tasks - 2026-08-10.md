# Pending Tasks - 2026-08-10

## Cross Tabs

### P0

- [/] Update crosstabs designs to be consistent with Enlyta design system.
...
- [ ] Design QA
	- [ ] Filter flows
	- [x] Previously raised Design QA re-test and close - Jira Ticket ED-1158
...
- [ ] Design System Rebuild in Figma.
...
- [ ] Create separate Persona Bot mockups for Bank of America and a generic persona, covering widget and web views.
- [ ] Work on the changes and feedback discussed by the team in the call today.
...
- [ ] Set up the design system rules for the UX/UI Agent.
