...
![[01_ux_focus-framework.png|A screen shot that displays a full screen labelled as Immersive, Whole app, and knowledge-base focus.]]

Let's explore each of these frameworks in more detail

### Immersive focus for a whole knowledge base

![[02_ux_immersive.png|A screen shots that shows a larger version of the full screen, immersive framework.]]
...
![[03_ux_assistive.png|A screen shot that shows a larger version of the side-bar, assistive framework.]]
...
![[04_ux_embedded.png|A screen shot that shows a larger version of the pop-up, embedded framework.]]
...
![[05_ux_input-1.png|Screen shot that shows an example of a input box with selectable suggestions.]]
...
![[06_ux_input-2.png|Screen shot that shows an example of a dialogue box with space to enter a link, a request, images, and overall tone.]]
...
![[07_ux_input-3.png|Screen shot that shows the tone setting options and prompts for actions copilot can take.]]
...
![[08_ux_output-1.png|Screen shot that shows the iterations of the prompt outputs based on user updates from the input.]]
...
![[09_ux_output-2.png|Screen shot that shows the recent copilot chat history.]]
...
![[10_ux_output-3.png|Screen shot that shows a dialogue box warning to be sure to review carefully before inserting, responses may contain inaccuracies.]]
...
![[11_ux_output-4.png|Screen shot that shows where to click within a copilot dialogue box to edit an output.]]
...
[Create accessible AI experiences - Training](https://learn.microsoft.com/en-us/training/modules/create-accessible-solutions-using-ai-innovations/?source=recommendations)

This module provides guidance on how to collaborate effectively with customers, partners, and the disability community to create innovative solutions that are accessible and inclusive. After you complete this module, you'll have a better understanding of how AI can empower and enable everyone.
